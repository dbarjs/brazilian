 ...
 */
export function generateCheckSums(numbers: Array<number>, validators: Array<number>): CheckSums {
  return validators.reduce<CheckSums>(([checkerA, checkerB], validator, index) => [
